<?php
            ...
            $letra = mysqli_real_escape_string($conexion, $letra);
             ...
             if($letra != ""){
                $consulta = mysqli_prepare($conexion, "SELECT Vehiculo.Id as id, Nombre as campo FROM Vehiculo INNER JOIN TipoVehiculo ON Vehiculo.IdTipoVehiculo = TipoVehiculo.Id where ($campo LIKE ?);");
                $letra = $letra . '%';
