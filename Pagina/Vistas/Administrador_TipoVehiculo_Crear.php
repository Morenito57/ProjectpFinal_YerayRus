<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        $perfil =  $TipoVehiculoBL->creacionTipoVehiculo($_POST['tipoVehiculo']);
                                ...
                                <table class="tabla_datos">
                                    <tr class="tr_datos">
                                        ...
                                        <td class="td_datos_input">
                                            <input type="text" class="inputs" id="tipoVehiculo" name="tipoVehiculo" placeholder="Tipo Vehiculo" pattern="[A-Za-z0-9áéíóúÁÉÍÓÚñÑ\s\-,.]+" required>
                                        </td>
                                    </tr>
                            </table>
