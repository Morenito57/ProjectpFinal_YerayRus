        ...
        <div class="divCuerpo">
            <div class="divCabezeraCuerpo">
                ...
                <?php
                      ...
                      echo "<option value=Inicio_Sin_Loggin.php>Todos</option>";
                      foreach($datosTipoVehiculos as $datosTipoVehiculo){
                        echo "<option value=Inicio_Sin_Loggin.php?tipoVehiculo=".urldecode($datosTipoVehiculo->getId()).">".$datosTipoVehiculo->getTipoVehiculo()."</option>";
                      }
                ?>
                </select>
                <a class="inicioSesion" href="loginVista.php">Inicia Sesion</a>
            </div>
            <div class="divRestoCuerpo">
                <div class="divOrdenar">
                    <label for="busqueda" class="lupa">🔎</label>
                    <input type="text" class="busqueda" id="busqueda" name="busqueda" onkeyup="obtenerDatosSinLogin()" placeholder="Busca">
                        ...
                        <?php
                            ...
                            if (!array_key_exists('orden', $query_params)) {
                                if (empty($query_params)) {
                                    echo ('
                                        <option value="Inicio_Sin_Loggin.php">Por defecto</option>
                            ...
                            if (!isset($datosVehiculos[$datosPagina])) {
                                ...
                                <div class='anuncio'>
                                    ...
                                    <div class='detallesAnuncio'>
                                        <div class='nombre'>
                                            <a class='enlace_compra' href='pantallaCompra_SinLoggin.php?id=".$datosVehiculos[$datosPagina]->getId()."'>
