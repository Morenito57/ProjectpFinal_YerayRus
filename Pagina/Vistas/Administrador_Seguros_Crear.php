<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        $perfil =  $TipoVehiculoBL->crearSeguro($_POST['seguro'], $_POST['precio']);
                                ...
                                <table class="tabla_datos">
                                    <tr class="tr_datos">
                                        <td class="td_datos_texto">
                                            <p class="datos_guardados">Seguro: </p>
                                        </td>
                                        <td class="td_datos_input">
                                            <input type="text" class="inputs" id="seguro" name="seguro" placeholder="Seguro" pattern="[A-Za-z0-9áéíóúÁÉÍÓÚñÑ\s\-,.]+" required>
                                        </td>
                                    </tr>
                                    <tr class="tr_datos">
                                        <td class="td_datos_texto">
                                        ...
                                        <td class="td_datos_input">
                                            <input type="number" class="inputs" id="precio" name="precio" placeholder="Precio" min="0" max="9999" required>
                                        </td>
                                    </tr>
                            </table>
