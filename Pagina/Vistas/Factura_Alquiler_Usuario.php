        ...
        <div class="divCuerpo">
            <div class="divCabezeraCuerpo">
                <div class="menu">
                    ...
                    <a href="Area_Personal_Historial_Alquileres_Usuario_Vista.php" class="volver">Volver a alquileres</a>
                ...
                <div class="caja_area_personal">
                    <div class="contenido">
                        ...
                        <?php
                            ...
                            $datosfactura = $facturaBL->obtener($usuarioOriginal, $idAlquilerDecodificado);   
                            echo'
