<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        $TipoVehiculoBL = new AlquileresNegocio();
                                ...
                                <table class="tabla_datos">
                                    <tr class="tr_datos">
                                        <td class="td_datos_texto">
                                            ';
                                                if($alquiler->getEstado() == 1 || $alquiler->getEstado() == True || $alquiler->getEstado() == "True"){
                                                    echo'<p class="datos_guardados">Estado: <span class="datosUser">True</span></p>';
                                                }elseif($alquiler->getEstado() == 0 || $alquiler->getEstado() == False || $alquiler->getEstado() == "False"){
                                                    echo'<p class="datos_guardados">Estado: <span class="datosUser">False</span></p>';
                                                }else{
                                                    echo'<p class="datos_guardados">Estado: <span class="datosUser">Cancelado</span></p>';
                                                }
                                            echo'
                                        </td>
                                        <td class="td_datos_input">
                                            <input type="text" class="inputs" id="estado" name="estado" placeholder="estado" pattern="(1|0|Null|null)"">
                                        </td>
                                    </tr>
