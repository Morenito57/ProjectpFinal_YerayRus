        ...
        <div class="divCuerpo">
            ...
            <div class="divRestoCuerpo">
                <div class="caja_area_personal">
                    <div class="contenido">
                        <h1>Actualizar Tipo Vehiculo</h1>
                                ...
                                <table class="tabla_datos">
                                    <tr class="tr_datos">
                                        <td class="td_datos_texto">
                                            <p class="datos_guardados">Nombre: <span class="datosUser">'.$datosTipoVehiculo[0]->getTipoVehiculo().'</span></p>
                                        </td>
                                        <td class="td_datos_input">
                                            <input type="text" class="inputs" id="tipoVehiculo" name="tipoVehiculo" placeholder="Tipo Vehiculo" pattern="[A-Za-z0-9áéíóúÁÉÍÓÚñÑ\s\-,.]+">
                                        </td>
                                    </tr>

                                    <input id="idTipoVehiculo" name="idTipoVehiculo" value="'.$datosTipoVehiculo[0]->getId().'" type="hidden">
